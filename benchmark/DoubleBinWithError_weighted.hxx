...
#ifndef DOUBLEBINWITHERROR_WEIGHTED
#define DOUBLEBINWITHERROR_WEIGHTED
...
struct DoubleBinWithErrorWeighted : public benchmark::Fixture {
  ...
  EPHist::EPHist<EPHist::DoubleBinWithError> h1{20, 0.0, 1.0};
